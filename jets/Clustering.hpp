...
std::vector<Bool_t> FindFinalParticles(Int_t const* motherIdxs, Int_t const* StatusArr, Int_t nGenPart, GenPartIndex const& idx); // marks all mothers as NOT final state (bc they decay)
