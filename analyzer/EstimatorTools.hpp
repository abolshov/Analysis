...
std::optional<LorentzVectorF_t> NuFromH(LorentzVectorF_t const& jet1, LorentzVectorF_t const& jet2, LorentzVectorF_t const& lep, LorentzVectorF_t const& met, bool add_deta, Float_t mh);
