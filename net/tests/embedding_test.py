...
def main():
    ...
    lep_embedding = Embedding(num_layers=1, 
                              num_units=512,
                              dim_embedding=512)
    ...
    jet_embedding = Embedding(num_layers=1, 
                              num_units=512,
                              dim_embedding=512)
    ...
    fatjet_embedding = Embedding(num_layers=1, 
                              num_units=512,
                              dim_embedding=512)
    ...
    met_embedding = Embedding(num_layers=1, 
                              num_units=512,
                              dim_embedding=512)
    ...
    particle_embedding = ParticleEmbedding(num_layers=1, num_units=512, dim_embedding=512)
    # particle_tensor = tf.concat([lep_tensor, met_tensor, jet_tensor, fatjet_tensor], axis=1)
