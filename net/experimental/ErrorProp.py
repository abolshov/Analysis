...
class ErrorPropagator():
    ...
    """
    def __init__(self, global_corr_mtrx, hbb_momentum, hvv_momentum):
        """
        expected momentum shape is (n_events, 4) or (n_events, 3)
        """
        self.global_corr_mtrx = global_corr_mtrx
    ...
    def _event_covar_mtrx(self, errors):
        ...
        event_covar_mtrx = np.matmul(np.matmul(std_mtrx, self.global_corr_mtrx), std_mtrx)
